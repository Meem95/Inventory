...
class ProductPosSaleController extends Controller
{
    public function index()
    {
        ...
        if($auth_user == "Admin"){
            ...
            //$productPosSales = ProductSale::latest()->get();
        }else{
            $productPosSales = ProductSale::where('sale_type','pos')->where('user_id',$auth_user_id)->latest()->get();
            //$productPosSales = ProductSale::where('user_id',$auth_user_id)->latest()->get();
        }
    ...
    public function create()
    {
       ...
       // $products = DB::table('product_purchase_details')
            ...
            //->where('products.product_type','=','Dress')
    ...
    public function selectedform($barcode){
        ...
        if(Cart::count() > 0):
            foreach(Cart::content() as $item):
                ...
                $html .= "<th>".$item->options['unit_name']."</th>";
                $html .= "<th><input type=\"text\" value=\"".$item->qty."\" size=\"5\" onBlur=\"updateCart(this,'$item->rowId')\" </th>";
                //$html .= "<th>".$item->qty."</th>";
        ...
        $html .= "</tbody>
                    ...
                    <div class=\"col-md-4\">
                        ...
                        <div class=\"form-group row\">
                            ...
                            <div class=\"col-md-8\">
                                 <input type=\"text\" class=\"form-control\" id=\"vat_amount\" name=\"vat_amount\" onkeyup=\"vatAmount('')\" value=\"0\">
                            </div>
                        </div>
                        <div class=\"form-group row\">
