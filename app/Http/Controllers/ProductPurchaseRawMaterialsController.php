...
//    }
    ...
    {
        $productPurchases = ProductPurchase::where('purchase_product_type','Gauze Cloth')->latest()->get();
        //dd($productPurchases);
    ...
    public function create()
    {
        ...
        $products = Product::where('product_type','Gauze Cloth')->get();
    ...
    public function store(Request $request)
    {
        ...
        $productPurchase ->purchase_product_type = 'Gauze Cloth';
        ...
        if($insert_id)
        {
            for($i=0; $i<$row_count;$i++)
            {
                ...
                $stock->stock_product_type = 'Gauze Cloth';
            ...
            $transaction->transaction_product_type = 'Gauze Cloth';
