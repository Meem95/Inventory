...
{{--                        </div>--}}
                        <div class="table-responsive">
                            ...
                            <tr>
                                ...
                                <th colspan="2">
                                    Discount Amount:
                                    <input type="text" id="discount_amount" class="form-control" name="discount_amount" value="0" onkeyup="discountAmount('')">
                                </th>
                                <th colspan="2">
                                    Total:
                                ...
                                <th colspan="2">
                                    Paid Amount:
                                    <input type="text" id="paid_amount" class="getmoney form-control" name="paid_amount" value="0" onkeyup="paidAmount('')">
                                </th>
                                <th colspan="2">
                                    Due Amount:
