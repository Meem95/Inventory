                        ...
                        <tr>
                            ...
                            <th>
                                @php
                                    ...
                                    $product_price = \App\ProductPurchaseDetail::where('product_id',$data->id)->latest()->pluck('mrp_price')->first();
                                @endphp
                            ...
                            <th>
                                @php
                                    ...
                                    $product_current_stock = \App\Stock::where('product_id',$data->id)->latest()->pluck('current_stock')->first();
                                @endphp
