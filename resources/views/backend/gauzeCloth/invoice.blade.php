                            ...
                            <div class="invoice p-3 mb-3">
                                ...
                                <div class="row invoice-info">
                                    <div class="col-md-8 invoice-col">
                                        <address>
                                            <strong>Hasan Fashion</strong><br>
                                            Hasan Fashion, Jahan Mansion (1st Floor),<br>
                                            29 Mirpur Road<br>
                                            (opposite of Teachers Training College)<br>
                                            Dhaka-1205<br>
                                            Bangladesh
...
{{--                                                </tr>--}}
                                ...
                                <div class="row no-print">
                                    <div class="col-12">
                                        <a href="{{route('product.pos.Sales-invoice-print',$productSale->id)}}" target="_blank" class="btn btn-success float-right"><i class="fas fa-print"></i> Print</a>
