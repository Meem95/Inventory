...
<div class="ticket">
    ...
    <p class="centered">Invoice NO:{{$productSale->invoice_no}}
        <br>Jahan Mansion (1st Floor), 29, Mirpur Road,Dhaka-1205
        <br>01608403796
        <br>hasan.fashion2021@gmail.com</p>
    <table>
        <thead>
        <tr>
    ...
    <table>
        ...
        <tr style="margin-top: 50px;">
            <td class="empty_space"></td>
            <td class="left_text">Sub Total</td>
            <td class="right_text">{{number_format($subtotal, 2, '.', '')}}</td>
        </tr>
        <tr style="margin-top: 50px;">
            <td class="empty_space"></td>
            <td class="left_text">Vat(Per)</td>
            <td class="right_text">{{number_format($vat_amount_value ? $vat_amount_value : 0, 2, '.', '')}}</td>
        </tr>
        <tr>
            <td class="empty_space"></td>
