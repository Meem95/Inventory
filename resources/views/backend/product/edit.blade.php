                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select name="product_type" id="product_type" class="form-control">
                                    <option value="Ready Made Garments" {{$product->product_type == 'Ready Made Garments' ? 'selected' : ''}}>Ready Made Garments</option>
                                    <option value="Fabrics" {{$product->product_type == 'Fabrics' ? 'selected' : ''}}>Fabrics</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
