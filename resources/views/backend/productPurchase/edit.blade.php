...
{{--                                        <input type="text" name="product_id[]" id="product_id" class="form-control" value="{{$productPurchaseDetail->product->name}}" readonly>--}}
                                    ...
                                    <td width="10%">
                                        <input type="text" min="1" max="" class="price form-control" name="price[]" value="{{$productPurchaseDetail->price}}" required >
                                    </td>
                                    <td width="10%">
                                        <input type="text" min="1" max="" class="form-control" name="mrp_price[]" value="{{$productPurchaseDetail->mrp_price}}" required >
                                    </td>
                                    <td width="10%">
