        ...
        $(function () {
            ...
            $('.add').click(function () {
                ...
                var tr = '<tr><td class="no">' + n + '</td>' +
                    ...
                    '<td style="width: 12%"><div id="product_unit_id_'+n+'"><select class="form-control product_unit_id select2" name="product_unit_id[]" id="product_unit_id_'+n+'" required>' + productUnit + '</select></div></td>' +
                    '<td><input type="text" class="form-control" name="rack_no[]"></td>' +
