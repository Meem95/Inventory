...
<head>
    ...
    <title>Login - Hasan Fashions</title>
</head>
<body>
<section class="material-half-bg" style="background-color: #313A95!important;">
    <div class="cover"></div>
</section>
<section class="login-content">
    <div class="logo">
{{--        <h1><img src="{{asset('uploads/logo.png')}}" alt="logo" height="auto" width="250px"></h1>--}}
        <h1><img src="{{asset('uploads/logo.jpg')}}" alt="logo" height="auto" width="250px"></h1>
    </div>
    @if (session('status'))
